    ...
    return (
        <div className='h-screen w-full overflow-hidden relative'>
            <img
                ...
                alt="Background-Hero"
            />
            <section className=' py-20 px-12 absolute top-0 left-0 w-full h-full flex flex-col  md:flex-row justify-center items-center text-left z-10'>
                <div className='container flex flex-col md:flex-row items-start md:items-center'>
                    <div className='flex flex-col md:order-1'>
                        <h1 className='text-primary font-bold text-5xl md:text-4xl xl:text-7xl mb-4 dark:text-tertiary'>
                            Soluciones Integrales{" "}
                            <span className='text-primary font-bold inline-block dark:text-tertiary underline decoration decoration-tertiary'>
                                para tu empresa
                            </span>
                        </h1>
                        <p className="mb-10 text-lg xl:text-2xl text-tertiary-foreground dark:text-white">

...
const HeroV3 = ({path, title, titleLine2, description, buttonText}) => {
    ...
    return (
        <div className='w-full h-auto px-8 py-24 bg-gradient-to-t from-white to-tertiary dark:from-primary dark:to-secondary'>
